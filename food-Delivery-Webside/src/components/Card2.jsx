    ...
    <div className='w-full h-[120px] p-2 shadow-lg flex justify-between '>
        <div className='w-[60%] h-full  flex gap-5'>
            ...
            <div className='w-[40%] h-full flex flex-col gap-3 '>
                ...
                <div className='w-[110px] h-[50px] bg-slate-600 flex rounded-lg overflow-hidden shadow-lg font-semibold border-2 border-green-400 text -xl '>
        ...
        <div>
            <div className='flex flex-col justify-start items-end gap-6'>
                ...
                <IoTrashBinSharp  className='w-[30px] h-[30px] text-red-400 cursor-pointer'onClick={()=>dispatch(RemoveItem(id))}/>
            </div>
